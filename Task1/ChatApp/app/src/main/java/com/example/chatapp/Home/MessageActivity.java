...
import com.example.chatapp.Home.Adapter.MessageAdapter;
import com.example.chatapp.Home.Fragment.APIService;
import com.example.chatapp.Home.Fragment.BottomSheetProfileDetailUser;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv_profile_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                openBottomSheetDetailFragment(profileUserNAme, profileImageURL);
            }
        });
